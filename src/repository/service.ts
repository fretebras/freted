...
import { ProviderConfig, ProviderName, Repository, RepositoryDefinition } from '../types'
...
export default class RepositoryService {
  ...
  async loadRepositoryDefinition(repository: Repository): Promise<RepositoryDefinition | undefined> {
